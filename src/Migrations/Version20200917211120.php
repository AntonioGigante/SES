 ...
 */
final class Version20200917211120 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipos CHANGE competicionesapuntadas competicionesapuntadas INT NOT NULL, CHANGE competicionesganadas competicionesganadas INT NOT NULL, CHANGE partidos partidos INT NOT NULL');
