 ...
 */
final class Version20201117193638 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipos DROP competicionesapuntadas, DROP competicionesganadas, DROP partidos');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipos ADD competicionesapuntadas INT DEFAULT NULL, ADD competicionesganadas INT DEFAULT NULL, ADD partidos INT DEFAULT NULL');
        $this->addSql('ALTER TABLE participaciones CHANGE user user INT DEFAULT NULL, CHANGE campeonato campeonato INT DEFAULT NULL');
        $this->addSql('ALTER TABLE pruebas CHANGE campeonato campeonato INT DEFAULT NULL');
